---
layout: Reference
title: Failover - Enable Disaster Recovery - REST API (Power Platform API) | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/rest/api/power-platform/environmentmanagement/failover/enable-disaster-recovery
uid: api.powerplatform.com.power-platform.environmentmanagement.failover.enabledisasterrecovery
...
description: 'Learn more about Power Platform API service - Enables disaster recovery on the specified environment. '
locale: en-us
document_id: 4a4cddf6-de9b-d26c-56e8-5195f878fee0
document_version_independent_id: 1a733247-b208-c76d-ce9c-7a4d96d033cd
original_content_git_url: https://github.com/MicrosoftDocs/powerplatform-rest/blob/live/docs-ref-autogen/power-platform/environmentmanagement/Failover/Enable-Disaster-Recovery.yml
site_name: Docs
...
asset_id: api/power-platform/environmentmanagement/failover/enable-disaster-recovery
moniker_range_name: 
monikers: []
item_type: Content
source_path: docs-ref-autogen/power-platform/environmentmanagement/Failover/Enable-Disaster-Recovery.yml
cmProducts:
- https://authoring-docs-microsoft.poolparty.biz/devrel/e6f942e8-55a7-4c86-b8e3-7456508ea850
spProducts:
- https://authoring-docs-microsoft.poolparty.biz/devrel/f1834696-48d6-470d-966b-6ee418881596
platformId: c2252c91-4589-5610-4009-03607b3e5514
---
...
```http
POST https://api.powerplatform.com/environmentmanagement/environments/{environmentId}/enableDisasterRecovery?api-version=2024-10-01
```

 With optional parameters: 

```http
POST https://api.powerplatform.com/environmentmanagement/environments/{environmentId}/enableDisasterRecovery?ValidateOnly={ValidateOnly}&ValidateProperties={ValidateProperties}&api-version=2024-10-01
```
