---
layout: Reference
title: User Per Flow Capacity Source - Get User Per Flow Capacity Source User Context Summary - REST API (Power Platform API) | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/rest/api/power-platform/licensing/user-per-flow-capacity-source/get-user-per-flow-capacity-source-user-context-summary
uid: api.powerplatform.com.power-platform.licensing.userperflowcapacitysource.getuserperflowcapacitysourceusercontextsummary
...
description: 'Learn more about Power Platform API service - Get the user per flow capacity source user context summary. '
locale: en-us
document_id: f0d3458c-40a9-8667-4027-5575ce107331
document_version_independent_id: 6737d442-3b0a-0eb5-caf5-ee0a12bc122e
original_content_git_url: https://github.com/MicrosoftDocs/powerplatform-rest/blob/live/docs-ref-autogen/power-platform/licensing/User-Per-Flow-Capacity-Source/Get-User-Per-Flow-Capacity-Source-User-Context-Summary.yml
site_name: Docs
...
asset_id: api/power-platform/licensing/user-per-flow-capacity-source/get-user-per-flow-capacity-source-user-context-summary
moniker_range_name: 
monikers: []
item_type: Content
source_path: docs-ref-autogen/power-platform/licensing/User-Per-Flow-Capacity-Source/Get-User-Per-Flow-Capacity-Source-User-Context-Summary.yml
cmProducts:
...
platformId: f63d64e3-72f7-09c3-c154-1c95874dac31
---
...
```http
GET https://api.powerplatform.com/licensing/UserPerFlowCapacitySource/UserContextSummary?startDate={startDate}&api-version=2024-10-01
```

 With optional parameters: 

```http
GET https://api.powerplatform.com/licensing/UserPerFlowCapacitySource/UserContextSummary?startDate={startDate}&endDate={endDate}&pageNumber={pageNumber}&pageSize={pageSize}&environmentId={environmentId}&api-version=2024-10-01
```
